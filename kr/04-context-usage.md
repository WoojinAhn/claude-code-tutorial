...
**실습:** 지금 `/context`를 실행해보세요. 이 튜토리얼이 컨텍스트를 얼마나 사용했는지 확인해보세요.

**확인:** 실행해봤나요? 컨텍스트 윈도우가 얼마나 차 있나요?
...
**실습:** API 요금제라면 지금 `/cost`를 실행해보세요. 구독 플랜이라면 다음 섹션(`/stats`)으로 건너뛰세요.

**확인:** 실행했다면 이 튜토리얼 세션의 비용을 확인할 수 있습니다. 실행할 수 없었다면 괜찮습니다 — `/stats`가 대안입니다.
...
**실습:** 지금 `/stats`를 실행해보세요. 어떤 사용 패턴이 보이는지 확인해보세요.

**확인:** 실행해봤나요? 어떤 결과가 나왔는지 알려주세요. 재미있는 패턴이 있었나요?
